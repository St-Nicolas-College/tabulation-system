...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    active_judges: Schema.Attribute.Relation<'manyToMany', 'api::judge.judge'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiJudgeJudge extends Struct.CollectionTypeSchema {
...
export interface ApiScoreScore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    judge: Schema.Attribute.Relation<'manyToOne', 'api::judge.judge'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
